...
def voter_menu(vm: VoterManager):
    while True:
        ...
        print("3.Searching a Voter")
        print("4.Deleting a  Voter")
        print("5.Back")
...
def cast_vote_flow(bm: BallotManager):
    ...
    try:
        ...
        seat_number = input("Candidate Seat Number (Only 2 digits): ").strip()
...
def trend_graph_flow(bm: BallotManager):
    ...
    try:
        ...
        print("\nOpen trend graph.html to view the trend graph.")
    except ValidationError as e:
        print(f"Error: {e}")
